    ...
    <section id="cases" className="ce-section" style={{ background: "var(--ce-bg-alt)" }}>
      <div className="ce-wrap">
        <div style={{ maxWidth: 720, marginBottom: 56 }}>
          <span className="ce-eyebrow">Кейсы</span>
          <h2 className="ce-h-display" style={{ fontSize: "clamp(32px, 4.4vw, 56px)", margin: 0 }}>Кейсы клиентов</h2>
          <p style={{ fontSize: 18, color: "var(--ce-text-2)", marginTop: 18 }}>Реальные цифры от ресторанов, клиник и салонов через 90 дней работы с Эмилией.</p>
        </div>
