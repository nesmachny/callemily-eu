...
export default async function NotFound() {
  ...
  return (
    <div style={{ background: "var(--ce-bg)", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "0 24px", textAlign: "center" }}>
